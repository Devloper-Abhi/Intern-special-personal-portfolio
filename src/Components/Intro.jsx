...
const Intro = (props) => {
  return (
    <div className={"flex px-8 justify-between h-screen duration-300 "+  (props.darkMode ? 'bg-[#181818] text-white' : 'bg-white')}>
      <div className="left">
        <div className="social flex flex-col gap-2 absolute bottom-10 left-15">
        ...
        <div className="info px-30 flex flex-col gap-1 justify-center h-[90%]">
          <span className={"bg-gradient-to-r from-[#32F6F6] to-[#A6A79F] rounded-t-4xl rounded-br-3xl text-4xl font-[Pacifico] text-white w-fit px-5 py-3 shadow-2xl " + (props.darkMode ? 'shadow-[#363636]' : 'shadow-[#0000004d]')}>
            Hello!
          </span>
          <h3 className="text-5xl font-[Varela Round] font-medium">
            I'm <span className={"underline " + (props.darkMode ? 'text-[#797979f1]' : 'text-[#363333f1]')}>Anish</span>
            <span
              className="inline-block animate-[wave_1.5s_infinite]"
              role="img"
          ...
          <div className="info-actions mt-9">
            <ul className="flex gap-4 text-xl font-[Varela Round]">
              <li
                className={"cursor-pointer bg-linear-to-r bg-gradient-to-r from-[#DF580C] to-[#FD993D] hover:from-[#FD993D] hover:to-[#DF580C]  transition-colors duration-1000 rounded-2xl px-5 py-3 text-white font-[Varela Round] border-white border-2 shadow-2xl " + (props.darkMode ? 'shadow-[#363636]' : 'shadow-[#0000004d]')}
              ><Link to="/cv">Download CV</Link>
                
              </li>
              <li className={"cursor-pointer bg-linear-to-r from-[#434343] to-[#181818] hover:from-[#181818] hover:to-[#434343] duration-1000 transition-colors px-5 py-3 text-white font-[Varela Round] border-white border-2 shadow-2xl rounded-2xl " + (props.darkMode ? 'shadow-[#363636]' : 'shadow-[#0000004d]')}>
      ...
      <div className="right w-fit m-auto">
        <img src="./Images/Image.png" alt="Anish" />
      </div>
    </div>
  );
};
